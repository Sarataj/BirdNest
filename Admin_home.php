...
<html>
	...
	<section id="banner">
		...
		<h1 class="heading"> Welcome <?php echo "<td>".$sql_1['A_name']."</td>"; ?></h1>
		<h3 class="heading"> This List of properties needs to Approve</h1>
				<div id= show_project>
					<?php
						$result = mysqli_query($db,"SELECT * FROM request_to_sell_product where P_approval = 'need_approval'");  //need_approval  {$_POST["P_approval"]}
